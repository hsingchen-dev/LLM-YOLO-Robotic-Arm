...
本プロジェクトは、神戸大学、東京大学などの研究者によって共同で開発されています。  
...
- **杭 星辰（ハン シンチェン）**（プロジェクトリーダー）– ロボットアーム制御、逆運動学、YOLO統合、LLMベースシステム設計を担当。政府向けプレゼン経験、国際共同研究経験、JST推薦獲得。  
  *神戸大学 修士課程*

- **李 天洋（リ テンヨウ）** – 3Dモデリング（CAD/SolidWorks）、ロボットの機械設計およびプロトタイピングを担当。YOLOベースの把持と逆運動学の調整も担当。  
  *神戸大学 修士課程*

- **孫 羽杉（ソン ウサン）** – システム統合、ソケット通信、バックエンド開発を担当。  
  *神戸大学 修士課程*
...
# 注意（Notice）  
本リポジトリは、就職活動および共同研究提案用ポートフォリオの一部です。  
本リポジトリのソースコードは全て公開されていません。  
